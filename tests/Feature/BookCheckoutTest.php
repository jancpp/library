...
//        $this->withoutExceptionHandling();
    ...
    public function only_signed_in_users_can_checkin_a_book()
    {
        ...
        Auth::logout(); // make sure user is not sign in
...
//        dd($user);
    ...
    /** @test */
    public function a_404_is_thown_if_book_is_not_checked_out_first()
    {
        $book = factory(Book::class)->create();
        $user = factory(User::class)->create();
        ...
        $this->actingAs($user)
            ->post('/checkin/' . $book->id)
            ->assertStatus(404); // we never checked the book out
